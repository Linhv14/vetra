...
const AccountBox = () => {
  const isAccountOpen = useSelector((state: appBehavior) => state.appBehavior.isAccountOpen)
  ...
  return (
    <div className={`${isAccountOpen && "show"} account relative p-c-15 rounded-lg w-full cursor-pointer bg-white flex items-center`} ref={accountRef}>
      ...
      <ul className="account-action absolute w-[60%] left-20 py-c-10 top-[80%] text-left bg-white rounded-lg z-10 transition-all duration-75 hidden" ref={actionRef}>
        <li>
          <a href="#" className="block text-sm px-5 py-c-10 hover:text-primary">
